...
data_message = np.load(
    "../data_midwife/data_numpy_clean_sf.npy",
    allow_pickle=True,
)
...
labels_kmeans_sf_768 = np.load(
    "../data_midwife/labels_kmeans_768.npy",
    allow_pickle=True,
)
...
def keyword_with_keybert(dico_label_message, save=False):
    ...
    if save:
        with open(
            "../keywords_midwife/dico_label_keyword_sf_bert_kmeans_dim768_eps0.2_min200.pkl",
            "wb",
        ) as f:
...
def keyword_with_tfidf(dico_label_message, save=False):
    ...
    if save:
        with open(
            "../keywords_midwife/dico_label_keyword_sf_tfidf_kmeans_dim768_eps0.2_min200.pkl",
            "wb",
        ) as f:
...
def keywords_with_tfidf_and_keybert(
    ...
    if save:
        with open(
            "../keywords_midwife/dico_label_keyword_sf_tfidf_bert_kmeans_dim768_eps0.2_min200.pkl",
            "wb",
        ) as f:
...
label_random = np.random.randint(0, len(np.unique(labels_kmeans_sf_768)))
pick_sentence_random(
    labels_kmeans_sf_768, data_message=data_message, label=label_random
)
...
display_all_keywords(labels_kmeans_sf_768)
